...
public class NewUI_ArtsCrafts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideModelsPen.add(new SlideModel("https://down-ph.img.susercontent.com/file/ph-11134207-7qul9-lk83fvi648do05",ScaleTypes.CENTER_CROP));
        slideModelsPen.add(new SlideModel("https://scontent.fmnl4-6.fna.fbcdn.net/v/t1.6435-9/152870297_452379642840143_6168932033046385146_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=dd63ad&_nc_eui2=AeH3xy6H2w5nMahjeAWp3mo2yeehT7zoKI_J56FPvOgojyj0HcMa7CpYtLY_-Qro-KnI4svoKZOPAckwaskWTOeI&_nc_ohc=-u-duVFFfIEAX_56BmV&_nc_ht=scontent.fmnl4-6.fna&oh=00_AfDHM8l9SjGgGBUgFpvNuywJH-0ChN93zpoi0AiHjhK2-g&oe=65AB5EE4",ScaleTypes.CENTER_CROP));
        slideModelsPen.add(new SlideModel("https://media.karousell.com/media/photos/products/2023/4/30/baybayin_ballpen_1682819470_1b877956.jpg",ScaleTypes.CENTER_CROP));
        ImgSliderPen.setImageList(slideModelsPen);
        ...
        slideModelsBags.add(new SlideModel("https://down-ph.img.susercontent.com/file/1c70b7a94217167b209c7d4ee35f9e2a",ScaleTypes.CENTER_CROP));
        slideModelsBags.add(new SlideModel("https://down-ph.img.susercontent.com/file/ph-11134207-7r98v-ll7872x9d48z5b",ScaleTypes.CENTER_CROP));
        slideModelsBags.add(new SlideModel("https://down-ph.img.susercontent.com/file/632a7e68791e6d4340abc0edb311fe78",ScaleTypes.CENTER_CROP));
        slideModelsBags.add(new SlideModel("https://www.wearlegazy.com/cdn/shop/files/Bayong2.0-Karamelo_1.jpg?crop=center&height=533&v=1696313154&width=800",ScaleTypes.CENTER_CROP));
        slideModelsBags.add(new SlideModel("https://www.merchiful.com/cdn/shop/products/1_d94fa8c0-442b-44c1-bfb4-8435240c6d23.jpg?v=1661933105",ScaleTypes.CENTER_CROP));
        ImgSliderBags.setImageList(slideModelsBags);
        ...
        slideModelsStickers.add(new SlideModel("https://down-ph.img.susercontent.com/file/bfec2b0f6e373b3bd356c68c1d48efe0",ScaleTypes.CENTER_CROP));
        slideModelsStickers.add(new SlideModel("https://down-ph.img.susercontent.com/file/020910927d8eb7cb52f70d5f73b5e328",ScaleTypes.CENTER_CROP));
        slideModelsStickers.add(new SlideModel("https://down-ph.img.susercontent.com/file/ph-11134201-7qul2-lkj1abovtfeme9",ScaleTypes.CENTER_CROP));
        slideModelsStickers.add(new SlideModel("https://down-ph.img.susercontent.com/file/e6a400fe257a5e90cb1856c83027b5b1",ScaleTypes.CENTER_CROP));
        slideModelsStickers.add(new SlideModel("https://www.sarapnow.com/cdn/shop/products/mie-makes-art-collectibles-mie-makes-mahal-kita-baybayin-sticker-i-love-you-sticker-tagalog-baybayin-alibata-filipino-philippines-laptop-sticker-hydroflask-waterbottle-30020876533847.jpg?v=1675678739&width=2000",ScaleTypes.CENTER_CROP));
        ImgSliderStickers.setImageList(slideModelsStickers);
        ...
        slideModelsAccessories.add(new SlideModel("https://down-ph.img.susercontent.com/file/e9868c68965addfc6a9e2a9e42345c59",ScaleTypes.CENTER_CROP));
        slideModelsAccessories.add(new SlideModel("https://down-ph.img.susercontent.com/file/503d1df3f6d4cb350d350edd1ea59015",ScaleTypes.CENTER_CROP));
        slideModelsAccessories.add(new SlideModel("https://down-ph.img.susercontent.com/file/1d89367552fb1bc9a449c32da43f18da",ScaleTypes.CENTER_CROP));
        slideModelsAccessories.add(new SlideModel("https://down-ph.img.susercontent.com/file/d45d084929e07d19963943f437c84170",ScaleTypes.CENTER_CROP));
        slideModelsAccessories.add(new SlideModel("https://down-ph.img.susercontent.com/file/ph-11134201-7r98o-lkwd4mbvl6ps33",ScaleTypes.CENTER_CROP));
        ...
        slideModelsCalligraphy.add(new SlideModel("https://imagevars.gulfnews.com/2019/07/31/190731-baybayin_16c46bc5266_large.jpg",ScaleTypes.CENTER_CROP));
        slideModelsCalligraphy.add(new SlideModel("https://drive.google.com/uc?id=1qm7AsXolvilst4zROJ1h9s6q0UCFKx7V",ScaleTypes.CENTER_CROP));
        slideModelsCalligraphy.add(new SlideModel("https://images.sbs.com.au/dims4/default/de6145e/2147483647/strip/true/crop/3264x1836+0+38/resize/1280x720!/quality/90/?url=http%3A%2F%2Fsbs-au-brightspot.s3.amazonaws.com%2Fdrupal%2Fyourlanguage%2Fpublic%2Fbaybayin1_1.jpg",ScaleTypes.CENTER_CROP));
        slideModelsCalligraphy.add(new SlideModel("https://www.baybayin.com/uploads/3/1/2/8/3128279/3903701_orig.jpg",ScaleTypes.CENTER_CROP));
        slideModelsCalligraphy.add(new SlideModel("https://drive.google.com/uc?id=1TH9305yAJtlLEThLrTDkOOL2owL32vr1",ScaleTypes.CENTER_CROP));
        slideModelsCalligraphy.add(new SlideModel("https://64.media.tumblr.com/9b9455dd3f32c902eaf8fe11b9b0c570/tumblr_mlsn29B75H1qzeh9bo1_640.jpg",ScaleTypes.CENTER_CROP));
        ImgSliderCalligraphy.setImageList(slideModelsCalligraphy);
        ...
        slideModelsTattoos.add(new SlideModel("https://images.summitmedia-digital.com/preview/images/2022/04/25/272935461_115494947555402_4623700061303765088_n-(1).jpg",ScaleTypes.CENTER_CROP));
        slideModelsTattoos.add(new SlideModel("https://i.pinimg.com/originals/f8/e6/9a/f8e69aa27a93d05b9566d0616905f5eb.jpg",ScaleTypes.CENTER_CROP));
        slideModelsTattoos.add(new SlideModel("https://images.summitmedia-digital.com/preview/images/2022/04/25/219154860_943788786400606_3944048259026654728_n-(1).jpg",ScaleTypes.CENTER_CROP));
        slideModelsTattoos.add(new SlideModel("https://sa.kapamilya.com/absnews/abscbnnews/media/ancx/style/2021/02/3roel.jpg",ScaleTypes.CENTER_CROP));
        slideModelsTattoos.add(new SlideModel("https://images.summitmedia-digital.com/preview/images/2022/04/25/140774981_850965592413618_2387209040066158877_n-(1).jpg",ScaleTypes.CENTER_CROP));
        ImgSliderTattos.setImageList(slideModelsTattoos);
        ...
        slideModelsEngraving.add(new SlideModel("https://i.etsystatic.com/40106744/r/il/493daf/4539009521/il_300x300.4539009521_fqxc.jpg",ScaleTypes.CENTER_CROP));
        slideModelsEngraving.add(new SlideModel("https://i.etsystatic.com/16232105/r/il/6a8eb1/4415865742/il_570xN.4415865742_1oq6.jpg",ScaleTypes.CENTER_CROP));
        slideModelsEngraving.add(new SlideModel("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGDTCyT4k-lYtbU6NE9zIHza4uxZC_V_T34g&usqp=CAU",ScaleTypes.CENTER_CROP));
        slideModelsEngraving.add(new SlideModel("https://obs.line-scdn.net/0hlDtP8A1aM2tJKRsBLUlMPHN_MAR6RSBoLR9idBZHbV8wGCE6fU16XmUhZQxsGnQ1Jx90D2ktKFo3HHw1dEx6/w644",ScaleTypes.CENTER_CROP));
        slideModelsEngraving.add(new SlideModel("https://64.media.tumblr.com/8f5e914da42439cf484edf70ab083df4/tumblr_n6iix9pIWm1s6239co1_640.jpg",ScaleTypes.CENTER_CROP));
        ImgSliderEngraving.setImageList(slideModelsEngraving);
