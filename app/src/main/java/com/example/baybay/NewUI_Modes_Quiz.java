...
public class NewUI_Modes_Quiz extends AppCompatActivity {
    ...
    private List<Z_QuizAdvanced_QuestionManager.Question> questionList_word;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Z_QuizAdvanced_QuestionManager questionManager_m = new Z_QuizAdvanced_QuestionManager();
...
//        }
    ...
    private void displayQuestion() {
        ...
        Tv_QuizQuestionCounter.setText(String.valueOf(QuizQuestionCounter) + "/20");

        if(QuizQuestionCounter != 20){
            QuizQuestionCounter ++;
        }
        ...
        if (questionsAnswered == questionItems) {
            ...
            if (difficulty == 1) {
                ...
                Z_QuizAdvanced_QuestionManager.Question currentQuestion = null;
                for (Z_QuizAdvanced_QuestionManager.Question question : questionList_word) {
    ...
    private void exitQuizActivity(){
        //Intent Quiz = new Intent(getApplicationContext(), NewUI_Gamemodes.class);
        //startActivity(Quiz);
